...
<body>
    ...
    <section class="category" id="category">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a class="btn" data-package-id="1">Get Price</a>
            </div>
            ...
            <div class="box">
                ...
                <a class="btn"  data-package-id="2">Get Price</a>
            </div>
            <div class="box">
                ...
                <a class="btn" name="package_id" data-package-id="3">Get Price</a>
            </div>
        </div>
    </section>
    <script>
                    const getPriceButtons = document.querySelectorAll('.btn');
                    getPriceButtons.forEach(button => {
                        button.addEventListener('click', async function () {
                            ...
                            if (response.ok) {
                                ...
                                this.parentElement.appendChild(priceElement);
                            }
                        });
                    });
                </script>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="tel:+916385443536"> <i class="fas fa-phone"></i> +91 6385443536 </a>
                <a href="mailto: libisenamarch@gmail.com"> <i class="fas fa-envelope"></i> libisenamarch@gmail.com </a>
                <a href="#"> <i class="fas fa-map"></i> Hosur, india - 635126 </a>
            </div>
    
            <div class="box">
                <h3>follow us</h3>
                <a href="#"> <i class="fab fa-facebook-f"></i> facebook </a>
                <a href="https://instagram.com/_.pavelika._5671._?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"> <i class="fab fa-instagram"></i> instagram </a>
                <a href="https://www.linkedin.com/in/libisena-panneer-selvam"> <i class="fab fa-linkedin"></i> linkedin </a>
                <a href="https://github.com/Libisenaps"> <i class="fab fa-github"></i> github </a>
            </div>
        </div>
        <div class="credit">created by <span>Libisena Panneer Selvam</span> | all rights reserved!</div>
    </section>
    <!-- footer section ends -->
